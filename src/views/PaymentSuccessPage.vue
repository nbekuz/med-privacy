...
<template>
  <section class="mx-auto max-w-2xl rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
    ...
    <h1 class="mb-2 text-2xl font-bold text-slate-900">To'lov muvaffaqiyatli yakunlandi</h1>
    <p class="mb-6 text-sm text-slate-700">
      Backend qaytaradigan Robokassa `success` query parametrlari ushlandi. Endi ilovaga qaytishingiz mumkin.
    </p>
